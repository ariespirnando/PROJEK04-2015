...
public class cSiswa extends javax.swing.JInternalFrame {
    ...
    public void bacaTable(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.NIS, s.nama_siswa, k.namakelas FROM siswa AS s, "
                   + "kelas AS k WHERE s.id_kelas = k.id_kelas";
    ...
    public void Pencarian(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.NIS, s.nama_siswa, k.namakelas FROM siswa AS s, kelas AS k "
                   + "WHERE s.id_kelas = k.id_kelas AND s.NIS LIKE '%"+jtNis.getText()+"%' or s.nama_siswa LIKE '%"+jtNis.getText()+"%' AND s.id_kelas = k.id_kelas";
           r=s.executeQuery(sql);
           ResultSetMetaData m=r.getMetaData();
           int kolom=m.getColumnCount();
           int baris=0;
